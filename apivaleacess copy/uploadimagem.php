...
header('Content-Type: application/json; charset=utf-8');  
  ...
  if($_FILES['photo'])
  {
      ...
      $photo_tmp_name = $_FILES["photo"]["tmp_name"];
          ...
          $upload_name = "http://10.68.36.111/apivaleacess/imagens".$random_name; 
          $upload_name = preg_replace('/s+/', '-', $upload_name);

          if(move_uploaded_file($_FILES["photo"]["tmp_name"],"img/" .$_FILES["photo"]["name"])) {
              //file uploaded to server
              $sql = "INSERT INTO denuncia (imagem_d, upload_d) VALUES ( '$photo_name', '$upload_name'  )"; //primeiro é o imgnome e dps upolad name
